...
def return_bundle_of_text(segments):
    ...
    while(i < len(segments)-1):
        small_li = []
        text_bundle_bigger_than_5 = (segments[i][0] == 255) and (segments[i][1] >= 5)
        space_bundle_smaller_than_15 = (segments[i][0] == 0) and (segments[i][0] <= 15)
        
        while text_bundle_bigger_than_5 or space_bundle_smaller_than_15:
